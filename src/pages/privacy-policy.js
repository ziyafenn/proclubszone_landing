      ...
      <Layout>
        ...
        <div className="content">
          <div className="privacyPolicy">
            ...
            <h1>Pro Clubs Zone - Privacy Policy</h1>

            <p>Effective date: January 28, 2021</p>

            <p>
              Pro Clubs Zone ("us", "we", or "our") operates the{" "}
              <a href="https://proclubs.zone">https://proclubs.zone</a> website
              and the Pro Clubs Zone mobile application (hereinafter referred to
              as the "Service").
            </p>
            ...
            <p>Pro Clubs Zone uses the collected data for various purposes:</p>
            <ul>
            ...
            <p>
              Pro Clubs Zone will take all steps reasonably necessary to ensure
            ...
            <p>
              Pro Clubs Zone may disclose your Personal Data in the good faith
              belief that such action is necessary to:
            </p>
            <ul>
              <li>To comply with a legal obligation</li>
              <li>
                To protect and defend the rights or property of Pro Clubs Zone
              </li>
              <li>
            ...
            <p>
              ...
              contact us by email: team@proclubs.zone
            </p>
            <div>
              <p>
                <a href="/">{"< Back to website"}</a>
